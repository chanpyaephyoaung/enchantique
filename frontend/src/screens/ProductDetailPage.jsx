...
const ProductDetailPage = () => {
   ...
   return (
      <Container type="page">
         ...
         {isLoading ? (
            <h2 className="mt-8">Please wait...</h2>
         ) : error ? (
            <h2 className="mt-8">{error?.data?.message || error.error}</h2>
         ) : (
            <div className="grid lg:grid-cols-2 py-8 gap-6">
               ...
               <div className="grid self-start gap-y-3">
                  ...
                  <Rating
                     ratingVal={currentProduct.rating}
                     reviewsCount={currentProduct.numReviews}
                  />
                  ...
                  <div className="grid gap-y-2">
                     ...
                     <p className="text-sm md:text-base font-semibol">
